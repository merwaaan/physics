...
L'algorithme \ref{constructionAABB} construit la boîte englobante d'un
...
\ref{detectionGrossiere} utilise ce principe.

\begin{algorithm}[h]
  \caption{Détection grossière}
  \label{detectionGrossiere}
  \dontprintsemicolon
...
processus est visible sur la figure \ref{dichotomie}.

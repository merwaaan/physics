...
déterminer si un objet doit être mis en sommeil, on observe la
magnitude de sa vitesse. On ne peut pas se baser sur ce facteur de
façon instantanée car un solide projeté en hauteur aura une vitesse

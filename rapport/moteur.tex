...
\begin{figure}
  \centering \subfloat[La boîte dispose initialement d'une vitesse
  ...
  \qquad \subfloat[La boîte rebondit sur le cube. Comme les points de
  ...
  \qquad \subfloat[La boîte rebondit à nouveau sur le cube. Cette fois
  ...
  \qquad \subfloat[La boîte entre en collision avec le sol et rebondit
...
Le pachinko est un jeu de hasard populaire au Japon. 
